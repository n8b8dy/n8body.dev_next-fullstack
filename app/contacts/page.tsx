...
export default function Contacts() {
  return (
    <Section className={cn('max-w-screen-xl items-center my-auto py-8 lg:flex-row lg:gap-[2%]')}>
      <div className={cn('px-2 py-4 items-center lg:flex-[0_0_49%]')}>
      ...
      <div className={cn('px-2 py-4 lg:flex-[0_0_49%]')}>
        <div className={cn('max-w-lg mx-auto')}>
          <h2 className={cn(
            'mb-4 text-3xl text-transparent font-semibold bg-clip-text',
            'animate-background-shine bg-gradient-FVW',
